...
export const LEVEL_CONFIG: Record<LevelName, LevelConfig> = {
  trace:       { label: 'TRC', color: '#a78bfa', bg: 'rgba(139,92,246,0.1)', border: 'rgba(139,92,246,0.4)', num: 0 },
  debug:       { label: 'DBG', color: '#34d399', bg: 'rgba(52,211,153,0.1)', border: 'rgba(52,211,153,0.4)', num: 1 },
  information: { label: 'INF', color: '#60a5fa', bg: 'rgba(96,165,250,0.1)', border: 'rgba(96,165,250,0.4)', num: 2 },
  warning:     { label: 'WRN', color: '#fbbf24', bg: 'rgba(251,191,36,0.1)',  border: 'rgba(251,191,36,0.4)',  num: 3 },
  error:       { label: 'ERR', color: '#f87171', bg: 'rgba(248,113,113,0.1)', border: 'rgba(248,113,113,0.4)', num: 4 },
  fatal:       { label: 'FTL', color: '#f43f5e', bg: 'rgba(244,63,94,0.1)',   border: 'rgba(244,63,94,0.4)',   num: 5 },
}
