  ...
  return (
    <div className={panelClass}>
      ...
      <div className="flex-1 overflow-y-auto px-3 py-3 flex flex-col gap-4 text-[12px]">
        {/* Message */}
        <div>
          <div className="text-[10px] font-bold tracking-[0.1em] uppercase text-gray-600 mb-1.5">Message</div>
        ...
        {propEntries.length > 0 && (
          <div>
            <div className="text-[10px] font-bold tracking-[0.1em] uppercase text-gray-600 mb-1.5">Properties</div>
        ...
        {entry.ex && (
          <div>
            <div className="text-[10px] font-bold tracking-[0.1em] uppercase text-gray-600 mb-1.5">Exception</div>
        ...
        {/* Raw */}
        <div>
          <div className="text-[10px] font-bold tracking-[0.1em] uppercase text-gray-600 mb-1.5">Raw</div>
